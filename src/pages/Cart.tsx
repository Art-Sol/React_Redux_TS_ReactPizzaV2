  ...
  return (
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__items content__items--cart">{pizzasList}</div>
...
const SvgIconClearCart: React.FC = () => {
  return (
    <svg
      width="20"
      height="20"
...
const SvgArrowLeftIcon: React.FC = () => {
  return (
    <svg
      width="8"
      height="14"
